...
Advisee <- data.table::fread(here::here("Data/Raw Data/S3_time1.csv"),
...
saveRDS(Advisee, file = here::here("Data/Study3_time1All.Rds"))
Advisee %>% write.csv("Data/Cleaned Data/S3_time1All_clean.csv")
...
saveRDS(Advisee1000, file = here::here("Data/Study3_time1.Rds"))
Advisee1000 %>% write.csv("Data/Cleaned Data/S3_time1_clean.csv")
