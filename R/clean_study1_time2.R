...
Competitors <- read.csv('Data/Raw Data/S1_Math50.csv') %>%
...
saveRDS(giver50, file = here::here("Data/Study1_time2_giver50.Rds"))
...
giver50 %>% write.csv("Data/Cleaned Data/S1_time2_giver50_clean.csv")
