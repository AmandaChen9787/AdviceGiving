...
saveRDS(giverStat, file = here::here("Data/Study1_time2.Rds"))
giverStat %>% write.csv("Data/Cleaned Data/S1_time2_clean.csv")


#calculate final ranking for each selfie
selfie <- readRDS(here::here("Data/Study1_time1_200.Rds"))
...
saveRDS(selfieStst, file = here::here("Data/Study1_finalRank.Rds"))
selfieStst %>% write.csv("Data/Cleaned Data/S1_time2_finalRank.csv")
