...
# find competitors
Competitors <- read.csv('Data/Raw Data/S2_Ability50.csv',
                        header = T,na.strings = '')[-c(1,2)] %>%
...
saveRDS(AdviceAll, file = here::here("Data/Study2_time2_advice.Rds"))
saveRDS(giver, file = here::here("Data/Study2_time2_giver.Rds"))

AdviceAll %>% write.csv("Data/Cleaned Data/S2_time2_advice_clean.csv")
giver %>% write.csv("Data/Cleaned Data/S2_time2_giver_clean.csv")
