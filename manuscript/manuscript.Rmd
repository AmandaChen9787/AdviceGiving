...
abstract: |
  The primary purpose of advice is often seen as helping recipients make better decisions and solve problems. However, this paper reveals that advisors are also influenced by interpersonal concerns. Specifically, we propose that advisors consider the recipient's "belief utility" and may seek to avoid disappointing them, resulting in what we call "flattering advice." Through three pre-registered experiments involving real interactions between advisors and advisees (n = 3,900), we demonstrate that advisors account for advisees' expectations, even when irrelevant to solving the problem. Specifically, advisors tailor their advice to match advisees' expectations about their own capabilities, aiming to avoid disappointing them (Study 1). Advisors inflate their advice due to interpersonal concerns, with those who care about being liked by the advisee inflating their advice to a greater extent. Advisees, in turn, reward this flattery, perceiving these advisors as more likable and equally trustworthy compared to those who aim to give more accurate advice (Study 2). Additionally, when advisors match advisees' expectations, men tend to receive more aspirational advice than women, due to their higher confidence, even when only expectations (not gender) are visible to the advisor. However, relying on these expectations leads to poorer decision outcomes (Study 3). We conclude by discussing the practical and theoretical implications of our findings, as well as directions for future research.
...
Individuals seek (and give) advice on complex choices in their professional and
personal lives. While advice is widely viewed as a mechanism for improving 
outcomes (CITE), recent findings suggest systematic gender differences in 
the advice received: men are more likely to be encouraged toward competitive 
positions and risk-taking behaviors (CITE, if real), and women are less likely to receive
criticism (CITE). These differences in advice can result in gender gaps in
career advancement, as opportunities often depend on individuals applying (even
if they do not meet all requirements, CITE-women apply for jobs when they meet all reqs)
and direct feedback, even if unpleasant, can help people improve their performance.
In this paper, we propose and present evidence for a novel mechanism to explain
gendered patterns in advice received: advisers are motivated by interpersonal
considerations and do not want to disappoint the advisee.

Models of decision-making that incorporate belief utility (Loewenstein & Molnar) 
imply a tradeoff between the benefits from having accurate beliefs and the
hedonic costs of receiving bad news. For example, someone expecting a good outcome
may feel disappointment if the realized outcome is not as good as what they had
expected holding accurate beliefs and the hedonic
costs of receiving bad news, such as disappointment from a desired outcome
failing to materialize (Gul and Pesendorfer, I think, disappointment aversion, Golman et al 2017). 
Because outcomes are frequently evaluated with respect to expectations
(Koszegi and Rabin), advice that falls short of someone's expectation can be
painful. Thus, advice may be shaped by the *beliefs* about someone else's
expectations.



perpetuate gender gaps in career advancement, as many opportunities depend on 
individual initiative and self-selection. This paper proposes a novel mechanism 
to explain gendered patterns in advice-giving: advisors calibrate their 
recommendations to match perceived advisee expectations. In professional 
contexts where women typically demonstrate lower confidence levels, advisors 
may provide less ambitious guidance that aligns with these reduced expectations.
In two experimental studies, we establish evidence for this expectation-matching 
mechanism. Specifically, men are more confident in their performance on a task
than women and advisers, who observe performance and confidence but not gender,
give more flattering advice to men than to women. A third experiment shows that 
advisors strategically provide "flattering" advice to avoid disappointing their 
advisees, further illuminating how interpersonal dynamics shape advice content.

For instance, in some studies, participants are asked to estimate 
quantities or choose between lotteries [@Benjamin2015]. Advisors are often 
motivated to provide accurate advice [@Jonas2003], and engage in perspective-taking
to align with the preferences of the advisee [@Kray2000; @Kray1999]. When 
uncertain, they may even prefer that advisees rely less on their recommendations
[@Ache2020]. This suggests that people are generally concerned with offering 
good advice, assuming accuracy is the primary objective.

Indeed, seeking and giving advice often involve complex conversational dynamics 
that can be challenging to manage. People frequently struggle with 
decisions about whom to approach for advice, whether they seek it too 
often or too little, and the potential consequences of asking for advice—or
failing to—when it’s expected [@lee1997;@minson2012;@see2011]. 
From the advisor's perspective, factors such as knowledge and expertise [@sniezek2001],
confidence [@sah2013], age [@zhang2020], and communication style [@yaniv2012]
also play critical roles in determining whether accurate advice is 
effectively conveyed.

While much of the advice literature emphasizes the instrumental value of 
advice—such as improving decision satisfaction or prediction accuracy, assuming
both parties prioritize accuracy—research suggests that solving the problem is 
not the only concern in these interactions. Advice seekers may feel embarrassed 
to ask for help [@Benabou2022] and may avoid seeking advice if they fear the 
information could lead to disappointment [@Gill2012]. Moreover, people tend 
to favor advisors who withhold unpleasant information [@Shalvi2019] and even 
punish those who tell them things they would rather not hear [@John2019] This 
indicates that individuals strategically select advice to shield themselves 
from uncomfortable truths, protecting the positive beliefs they hold about 
themselves and their anticipated future [@Loewenstein2018;
@Loewenstein1987]. But do advice givers recognize and account 
for the emotional cost of delivering honest information to the recipient?

In many real settings, advice often incorporates beliefs about the
...
In a large, preregistered experiment (n = 1,200), we demonstrate that 
advisors take into account advisees' expectations, even when those expectations
offer no relevant insights for solving the decision-making problem. 
Advisors were more likely to encourage advisees to compete against strong
competitors when they saw that the advisees had high expectations of their 
own abilities, compared to when the advisees had low expectations. In a second
preregistered experiment (n = 700), we show that advisors respond to interpersonal
incentives, telling advisees they are more attractive than they believe, and 
inflating their advice more when incentivized for likability rather than accuracy.
Notably, they still inflate their advice even when incentivized solely for accuracy.
Advisees, in turn, reward this flattering advice, rating these advisors as more 
likable and no less trustworthy than those who provide more accurate feedback. 
In the third preregistered experiment (n = 2,000), we replicate the finding that
advisors consider advisees' expectations when giving advice. Additionally, we find
that when only expectations (but not gender) are shown, men receive more aspirational
advice than women. This tendency to factor in expectations ultimately leads to poorer
advice, even when advisors are incentivized based on the outcome of the advisee’s 
decision.
