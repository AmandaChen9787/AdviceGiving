...
than rank them uniquely. We remove XX participants who did not follow instructions
and provide a unique ranking.

<!-- David: Note the number above to fill in. -->
...
```{r study2Rating, fig.cap="The evaluation of advice givers", eval = F}
